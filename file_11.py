...
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/250965724129877/')
#------------------[ Mamun-king ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/profile.php?id=100089814906004')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mRandom-X ]\33[1;38m     \033[1;31m 
╠══[Facebook                 • Mahdi Hasan Mamun ]     \033[1;97m  
╠══[Github                   • \33[1;38mMamunking01 ]   \33[1;34m   
╠══[Whatsapp                 • 01878046183 ]  \33[1;35m 
╠══[TOOLS                    • PAID ]          \33[1;32m   
...
os.system('espeak -a 300 " Welcome,  To,  Our, Paid, Tools"')
pass
...
def menu():
    ...
    if MAMUN in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801878046183')
        os.system("python file_11.py")
    elif MAMUN in ['3','03']:
        result()
    elif MAMUN in ['0']:
